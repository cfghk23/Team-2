...
import styles from './WithdrawAfterSlider.module.scss';

export default function WithdrawAfterSlider({
  title,
  value,
  setValue,
  ranges,
  ...
  return (
    <div className={styles.container}>
      <div className={styles.titleRow}>
        <h4>{title}</h4>
        <div className={styles.withdrawafterDisplay}>
          <input
            className={styles.withdrawafterInput}
