...
import styles from './InvestPeriodSlider.module.scss';

export default function InvestPeriodSlider({
  title,
  value,
  setValue,
  ranges,
  ...
  return (
    <div className={styles.container}>
      <div className={styles.titleRow}>
        <h4>{title}</h4>
        <div className={styles.investperiodDisplay}>
          <input
            className={styles.investperiodInput}
